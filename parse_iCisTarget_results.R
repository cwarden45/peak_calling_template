...
inputBed = "../Result/i-cisTarget_motif/input_files/merged_peaks_2kb_[compID]_[direction].bed"
outputResult = "../Result/i-cisTarget_motif/merged_peaks_2kb_[compID]_[direction]_peaks/statistics.tbl"
outputMapping = "../Result/i-cisTarget_motif/merged_peaks_2kb_[compID]_[direction]_peaks/input_mapped_to_icistarget_regions.bed"
outputFile = "../Result/i-cisTarget_motif/merged_peaks_2kb_[compID]_[direction]_peaks.txt"
