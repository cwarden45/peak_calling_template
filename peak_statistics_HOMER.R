...
HOMER.peak.file = "Peaks"
peak.length.dist = "HOMER_peak_length_dist.png"
peak.length.stats = "HOMER_peak_length_dist.txt"
...
bedFiles = paste(HOMER.peak.file,"/", longID,".bed",sep="")
...
gtf.table = data.frame(chr=merged.peaks$seqnames, source=rep("merged_HOMER_peaks",nrow(merged.peaks)),
